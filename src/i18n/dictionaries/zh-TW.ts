  ...
  announcements: {
    ...
    notices: [
      ...
      },
      {
        ...
        posterAlt: 'Gold House 2.0 正式發布公告海報',
        posterTags: ['Gold House 2.0', 'U 卡升級', '1 對 1 紅包與轉帳', '會議 VIP'],
        posterWidth: 1080,
        posterHeight: 1620,
        greeting: '尊敬的 Gold House 用戶：',
        paragraphs: [
          'Gold House 2.0 現已正式發布。',
          '本次版本圍繞支付、社交、會議權益及資產管理等核心場景進行全面升級，在帶來全新功能的同時，也對多項使用體驗進行了優化。',
        ],
        listIntro: '本次版本的重要升級與體驗優化包括：',
        listItems: [
          'U 卡全新升級',
          '新增 1 對 1 紅包與轉帳功能',
          '會議 VIP 權益體系全面升級',
          '提升錢包數量上限，並新增錢包分組、全部隱藏與恢復功能',
          '優化資產顯示，僅顯示白名單內的代幣餘額',
          '代幣詳情頁新增對應交易記錄，資產動向更加清晰',
          '優化 DApp 詳情頁樣式，移除底部地址欄，瀏覽體驗更加簡潔',
          '優化群組成員排序及邀請狀態提示',
          'iOS 新增原圖上傳與下載支援',
          '完成更多細節優化與使用者體驗升級',
        ],
        closingParagraphs: [
          '請將 Gold House 更新至 2.0.0 版本，體驗本次帶來的全新功能與優化。',
          '感謝每一位用戶一路以來的陪伴、支持與信任。',
          '偉大的事物，往往始於微小。Gold House 2.0，不只是一次版本更新，更是一個全新篇章的開始。',
        ],
      ...
      },
      {
        ...
        posterAlt: 'GoldHouse U 卡退款全部完成及打款結果公示公告海報',
        posterTags: ['U 卡退款', '667 筆', '20,627.07 USDT', '打款公示'],
        posterWidth: 1080,
        posterHeight: 1620,
        attachments: [
          {
        ...
        greeting: '親愛的黃金屋用戶：',
        paragraphs: [
          '黃金屋原有 U 卡相關退款工作現已全部完成。',
          '本次退款涵蓋用戶原有 U 卡的開卡費用及卡內餘額。所有退款均按照最高標準進行核算與發放，充分保障每一位用戶的資產權益，確保最終退款金額只多不少。',
          '本次退款共完成：打款總筆數 667 筆，打款總金額 20,627.07 USDT。',
          '相關款項均已退回至用戶對應的黃金屋錢包地址。若用戶建立了多個黃金屋錢包地址，則按照此前公布的規則，預設退回至用戶建立的第一個錢包地址。',
          '為保證本次退款流程公開、透明、可核查，現同步公布 USDT 打款公示表。',
        ],
        listIntro: '公示表中包含：',
        listItems: [
          '打款錢包地址',
        ...
        closingParagraphs: [
          '為保護用戶隱私，公示表中的錢包地址已進行脫敏處理，地址中間部分字元統一顯示為 XXXXXX。用戶可根據錢包地址前後字元及實際到帳金額，自行核對退款記錄。',
          '請各位用戶及時查看錢包到帳情況。如有疑問，請透過黃金屋官方渠道聯絡工作人員進行核查。',
          '本次退款工作的順利完成，離不開每一位用戶的理解、耐心與支持。黃金屋將繼續堅持用戶資產權益優先，不斷完善平台服務與資產管理體系，為用戶提供更加安全、透明、高效的服務體驗。',
          '感謝所有用戶一直以來的支持與信任。',
        ],
        signature: '黃金屋團隊',
    ...
    releases: [
      ...
      },
      {
        ...
        summary:
          '本次更新推出官方認證徽章體系（藍 V / 金 V），新增檔案轉發功能，群主與管理員可撤回群內垃圾訊息，同時修復大量已知問題並大幅優化效能與系統回應速度。',
        groups: [
          {
            type: 'feature',
            items: [
              '加入官方認證徽章，支援藍 V 標誌與金 V 標誌',
              '新增檔案轉發功能',
              '群主 / 管理員新增撤回群內垃圾訊息的功能',
            ],
          },
