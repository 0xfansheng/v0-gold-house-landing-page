...
const en: Dictionary = {
  ...
  nav: {
    ...
    start: 'Get Started',
    webApp: 'Web App',
    webAppAriaLabel: 'Open the GoldHouse web app in your browser',
  ...
  hero: {
    ...
    downloads: {
      ...
      webSmall: 'Web App',
      webName: 'Open in browser',
      webAriaLabel: 'Open the GoldHouse web app in your browser — no install needed',
  ...
  cta: {
    ...
    webAppLabel: 'Open the GoldHouse web app in your browser — no install needed',
    webAppText: 'Web App',
    webAppSmall: 'Instant · no install',
    comingSoon: 'Coming soon',
  ...
  accountDeletion: {
    ...
    metaTitle: 'Account Deletion Request — GoldHouse',
    metaDesc: 'GoldHouse Account Deletion: learn how to permanently delete your account and which data we will remove or retain.',
    badge: 'Account & Privacy',
    lastUpdated: 'Last updated: May 2026 · This page describes how to permanently delete your GoldHouse account and the data we will remove or retain.',
    howToTitle: 'How to Delete Your Account',
    howToIntro: 'You can delete your GoldHouse account using either method below.',
    inAppLabel: 'Option 1 · In-App',
    inAppDesc: 'Open GoldHouse → Settings → Account → Delete Account → Confirm',
    emailLabel: 'Option 2 · Email',
    emailDescPart1: 'Send an email from the address associated with your account to ',
    emailAddress: 'support@goldhouse.cc',
    emailDescPart2: ' with the subject line ',
    emailSubject: 'Delete My Account',
    emailDescPart3: '. We will process your request within ',
    emailDays: '15 business days',
    emailDescPart4: '.',
    deletedTitle: 'Data That Will Be Deleted',
    deletedIntro: 'Upon account deletion, the following data will be permanently removed:',
    deletedBullets: [
      'Profile information (nickname, avatar, bio, DID associations)',
      'Chat messages, media files, and group conversation history',
      'Contact lists and community memberships',
      'Posts, comments, likes, and saved items',
      'Wallet binding records and local caches (does not affect on-chain assets themselves)',
      'Notification preferences and app settings',
    ],
    retainedTitle: 'Data That May Be Retained',
    retainedIntroPart1: 'For legal, security, or compliance purposes, the following data may be retained for up to ',
    retainedDays: '90 days',
    retainedIntroPart2: ' after the deletion request takes effect:',
    retainedBullets: [
      'Transaction and payment records (to meet financial-regulation and AML requirements)',
      'Account activity logs (for risk control and anti-fraud investigations)',
      'The minimum data required to comply with legal obligations or respond to law-enforcement requests',
    ],
    retentionNote: 'After the retention period, all remaining data will be permanently deleted and cannot be recovered.',
    chainNoticeTitle: 'About On-Chain Data',
    chainNoticeIntro:
      'Please note: transaction records and DID identifiers written to public blockchains are immutable. GoldHouse cannot remove this information from the blockchain. Account deletion only applies to data held within the GoldHouse platform.',
  ...
  announcements: {
    ...
    notices: [
      ...
      },
      {
        ...
        posterAlt: 'Gold House 2.0 official release announcement poster',
        posterTags: ['Gold House 2.0', 'U Card upgrade', '1-to-1 transfers', 'Conference VIP'],
        posterWidth: 1080,
        posterHeight: 1620,
        greeting: 'Dear Gold House users,',
        paragraphs: [
          'Gold House 2.0 is now officially available.',
          'This release delivers comprehensive upgrades across payments, social features, conference benefits, and asset management, alongside a wide range of user experience improvements.',
        ],
        listIntro: 'Major features and experience improvements include:',
        listItems: [
          'A fully upgraded U Card experience',
          'New one-to-one red envelope and transfer features',
          'A comprehensive upgrade to the Conference VIP benefits system',
          'A higher wallet limit with wallet groups, hide-all, and restore features',
          'A cleaner asset view that displays balances only for allowlisted tokens',
          'Related transaction history added to token detail pages for clearer asset tracking',
          'A refined DApp detail page with the bottom address bar removed',
          'Improved group member sorting and invitation status indicators',
          'Original-quality image upload and download support on iOS',
          'Additional detail refinements and user experience improvements',
        ],
        closingParagraphs: [
          'Update Gold House to version 2.0.0 to experience the new features and improvements in this release.',
          'Thank you to every user for your continued support, trust, and companionship.',
          'Great things often begin with something small. Gold House 2.0 is more than a version update—it marks the beginning of a new chapter.',
        ],
        signature: 'The Gold House Team',
        signatureDate: 'August 2, 2026',
      },
      {
    ...
    releases: [
      ...
      },
      {
        ...
        groups: [
          {
            type: 'feature',
            items: ['Added the U Card, which can be claimed after registering an account'],
          },
          {
            type: 'improvement',
            items: [
              'A range of improvements to meetings',
              'A range of improvements to group chats',
            ],
          },
          {
            type: 'fix',
            items: ['Further improved overall stability'],
          },
        ],
      },
      {
  ...
  openSourceNotice: {
    ...
    metaTitle: 'GoldHouse — Open Source Software Notice (Android)',
    metaDesc: 'A list of third-party open source software used in the GoldHouse Android client.',
    badge: 'Open Source Notice',
    intro: 'Notices for third-party software that may be contained in portions of this product.',
    versionNote: 'Notice version 1.0.0 · 2026-04-23',
    footerNote:
      'This list covers open source software packaged inside the GoldHouse Android application. Each component remains the property of its respective authors and is distributed under the license indicated. Full license texts are available at the upstream project pages linked above.',
    groups: {
