              ...
              <ScrollReveal key={card.type} delay={((i + 1) as 1 | 2 | 3)}>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Icon */}
                    <div
                      className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${visual.gradient} flex items-center justify-center text-white mb-6 transition-transform duration-300 group-hover:scale-110`}
                      aria-hidden="true"
                    >
                      {visual.icon}
                    </div>
