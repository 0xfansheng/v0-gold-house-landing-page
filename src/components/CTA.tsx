...
const DOWNLOAD_VERSION = 'v2.0.2'; // Android APK direct download
const TESTFLIGHT_VERSION = 'v2.0.2'; // iOS TestFlight beta
const GOOGLE_PLAY_VERSION = 'v2.0.0'; // Android Google Play
