...
const DOWNLOAD_VERSION = 'v1.0.9'; // Android APK direct download
const TESTFLIGHT_VERSION = 'v1.0.9'; // iOS TestFlight beta
const GOOGLE_PLAY_VERSION = 'v1.0.9'; // Android Google Play
