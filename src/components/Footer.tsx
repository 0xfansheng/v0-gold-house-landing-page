...
const communityLinksData = [
  {
    key: 'twitter',
    label: 'Twitter / X',
    href: 'https://x.com/goldhousedotcc',
    icon: (
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-10 py-14">
          ...
          <div>
            ...
            <div className="mt-4 pt-4 border-t border-white/8">
              ...
              <Link href="/announcements" className="text-sm text-white/45 hover:text-white transition-colors duration-200 block mb-2">
                {f.updates}
              </Link>
              ...
              <Link href="/account-deletion" className="text-sm text-white/45 hover:text-white transition-colors duration-200 block mb-2">
                {f.accountDeletion}
              </Link>
              <Link href="/child-safety" className="text-sm text-white/45 hover:text-white transition-colors duration-200 block">
                {f.childSafety}
              </Link>
            </div>
          </div>
